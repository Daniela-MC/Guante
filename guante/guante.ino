...
void Timer2int()
{
  TCNT2=98;  // reinicia el contador (255-98)
 ...
 ISR(TIMER2_OVF_vect)
 {
  ...
  valx = map(valx, 266, 400, 0, 200);  // se hace la caracterizacion del acelerometro y segun las lecturas se asigna un valor acorde con las coordenadas que se estan trabajando en processing
  valy = map(valy, 275, 400, 200, 400);
  valz = map(valz, 275, 400, 400, 600 );
 }
